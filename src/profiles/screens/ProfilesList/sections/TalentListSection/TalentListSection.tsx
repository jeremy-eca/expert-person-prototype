...
export const TalentListSection = ({ onPersonSelect, onCreatePerson }: TalentListSectionProps): JSX.Element => {
  ...
  const handleAddPerson = () => {
    if (onCreatePerson) {
      onCreatePerson(); // Use dedicated create person flow
    } else {
      onPersonSelect(null); // Fallback to old behavior
    }
  };
