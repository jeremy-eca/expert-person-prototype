...
import { ApiConnectionStatus } from "../../../shared/components/ui/api-connection-status";
...
export const ProfilesEdit = ({ personId, onBack, onPersonSelect }: ProfilesEditProps): JSX.Element => {
        ...
        {activeProfileSection === "work" ? (
          ...
          <ProfileSection 
            ...
            onPersonCreated={(personId) => {
              // Navigate to the created person or stay on the form
              // Option 1: Stay on the form to show the created person
              if (onPersonSelect) {
                onPersonSelect(personId);
              }
              
              // Option 2: Go back to list after a short delay to see the success message
              setTimeout(() => {
                onBack();
            ...
            isNewPerson={personId === null || personId === 'new'}
          />
        )}
      </div>
    </div>
