...
import { PersonalInfoCardECA } from './components/PersonalInfoCardECA';
import { ContactDetailsCardECA } from './components/ContactDetailsCardECA';
import { AddressInfoCardECA } from './components/AddressInfoCardECA';
import { AdditionalInfoCardECA } from './components/AdditionalInfoCardECA';

export const ProfilesCreateECA: React.FC<ProfilesCreateProps> = ({
  onPersonCreated,
  onCancel
}) => {
  const {
        ...
        <div className="flex-1 px-6 py-8">
          <div className="max-w-4xl mx-auto">
            <div className="space-y-6">
              ...
              <ContactDetailsCardECA />

              {/* Address Information Card */}
              <AddressInfoCardECA />

              {/* Additional Information Card */}
              <AdditionalInfoCardECA />
